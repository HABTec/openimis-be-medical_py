...
DEFAULT_CFG = {
    ...
    "gql_query_medical_lab_services_perms": ['128301'],
    ...
    "gql_mutation_medical_lab_services_add_perms": ['128302'],
    "gql_mutation_medical_lab_services_update_perms": ['128303'],
    "gql_mutation_medical_lab_services_delete_perms": ['128304'],
}
